...
const NewsLetter = () => {
 ...
 <h2
  className="
    text-2xl sm:text-3xl md:text-4xl xl:text-4xl 2xl:text-5xl
   
    md:tracking-wide xl:tracking-widest
    leading-[2.2rem] xl:leading-[3.6rem] 2xl:leading-normal
    drop-shadow-md
  "
>
  Stay Home{" "}
  <span className="bg-black px-2 rounded-md">&amp; Get All</span> <br className="hidden md:block mb-2" />
