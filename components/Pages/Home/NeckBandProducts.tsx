...
type NeckBandProductsProps = {
  products?: ProductType[];
};

const NeckBandProducts = ({ products }: NeckBandProductsProps) => {
  ...
  return (
    <div className="md:w-11/12 w-10/12 mx-auto py-10">
      {/* Header Section */}
...
export default NeckBandProducts;
