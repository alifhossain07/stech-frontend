...
const DealerHero = () => {
    ...
    return (
        <section className="relative w-full h-[500px] md:h-[700px] flex flex-col items-center justify-center text-center overflow-hidden bg-black pt-10 md:pt-20">
            ...
            {/* Content Container */}
            <div className="relative z-10 md:w-11/12 max-w-6xl px-4 flex flex-col items-center gap-6">
                {/* Main Heading */}
                <h1 className="text-xl md:text-3xl lg:text-4xl 2xl:text-5xl font-extrabold text-white leading-tight">
                    {data.title}
                </h1>
                ...
                <div className="relative w-full max-w-xl mt-4 group">
                    <input
                        ...
                        className="w-full h-10 md:h-14 px-6 py-4 bg-white rounded-full text-black placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all duration-300 shadow-2xl"
                    />
                    <button
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-4">
                    <button onClick={() => window.open(data.button_links[0], "_blank")} className="flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 border border-white/30 rounded-full text-white bg-white/5 hover:bg-white/10 hover:border-white transition-all duration-300 group">
                    ...
                    <button onClick={() => window.open(data.button_links[1], "_blank")} className="flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 border border-white/30 rounded-full text-white bg-white/5 hover:bg-white/10 hover:border-white transition-all duration-300 group">
                        <span className="p-1 rounded-full border border-white/30 group-hover:border-white transition-colors">
