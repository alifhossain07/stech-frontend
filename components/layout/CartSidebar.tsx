...
export default function CartSidebar() {
  ...
  return (
    <>
      {/* Floating Cart Button — hide when open */}
      {!isOpen && (
        <button
...
>
  ...
  <div className="p-4 bg-gray-100 rounded-xl border text-sm">
    ...
    {/* TOP ROW: All (left) + Subtotal + Discount (right block) */}
    <div className="flex justify-between items-start">
      
      {/* LEFT: ONLY All checkbox */}
      <label className="flex items-center gap-2 cursor-pointer">
        <input
          type="checkbox"
          checked={allSelected}
      ...
      {/* RIGHT: Sub-total + Discount stacked */}
    ...
    {/* TOTAL (Right aligned under line) */}
