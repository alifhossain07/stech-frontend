...
export default function ProductWarrantyContent() {
    ...
    return (
        <div className="min-h-screen bg-[#FDFDFD] pb-[20vh] xl:pt-28 pt-12">
            <div className="max-w-7xl mx-auto px-4">
                <h1 className="text-xl md:text-3xl font-bold text-center text-orange-500 mb-5 xl:mb-16">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="bg-white rounded-[2.5rem] shadow-[0_10px_50px_rgba(0,0,0,0.04)] p-8 md:p-14 flex flex-col items-center mb-12 animate-fadeIn transition-all">
                        <form onSubmit={handleSearch} className="w-full max-w-2xl">
                            <div className="md:mb-10 mb-5 text-center md:text-left">
                                ...
                                <input
                                    ...
                                    className={`w-full h-8 md:h-12 bg-white border border-gray-200 rounded-xl px-6 md:text-xl text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all placeholder:text-gray-300 ${mobileError ? "ring-2 ring-red-500 bg-red-50 text-red-600 border-red-500" : ""}`}
                                />
                                {mobileError && (
                            ...
                            <div className="flex gap-4 justify-center">
                                <button
                                    type="button"
                                    onClick={handleReset}
                                    className="xl:px-12 xl:py-3 px-3 py-1 rounded-full bg-gray-100 text-gray-600 font-semibold text-sm md:text-lg hover:bg-gray-200 transition-all min-w-[140px]"
                                >
                                    Reset
                                </button>
                                <button
                                    type="submit"
                                    disabled={isLoading}
                                    className="xl:px-12 xl:py-3 px-3 py-1 rounded-full bg-orange-500 text-white font-semibold text-sm md:text-lg hover:bg-orange-600 transition-all shadow-lg shadow-orange-200 min-w-[140px] disabled:opacity-70"
                                >
