    ...
    return (
        <div className="w-11/12 mx-auto my-10">
            ...
            <div className="bg-white flex justify-center rounded-xl p-5 md:p-6 lg:p-8">
                <div
                    className="grid grid-cols-1 xl:grid-cols-2 gap-10 justify-center 2xl:grid-cols-[840px_840px]"
                >
                    {/* FORM SIDE */}
                    <div className="bg-[#f4f4f4] rounded-xl px-6 py-10 w-full 2xl:w-[840px] 2xl:h-[800px] flex flex-col">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4 flex-grow">
                            ...
                            <div className="flex-grow flex flex-col">
                                <label className="text-lg text-[#434343] font-medium">Your Message *</label>
                                <textarea
                                    name="content"
                    ...
                    {/* MAP SIDE */}
                    <div className="rounded-xl overflow-hidden w-full h-[400px] md:h-[600px] xl:h-[800px] 2xl:w-[840px] 2xl:h-[800px]">
                        <iframe
            ...
            <div className="w-full flex justify-center items-center my-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 xl:grid-cols-3 gap-8 md:gap-[99px] place-items-center">
                    <Card
...
function Card({ icon, title, text }: CardProps) {
    ...
    return (
        <div className="bg-white shadow-xl rounded-2xl flex flex-col items-center justify-center text-center w-full max-w-[445px] h-auto md:h-[376px] px-6 py-10">
