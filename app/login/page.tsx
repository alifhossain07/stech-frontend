...
const Page = () => {
  return (
    <div className="flex items-center justify-center py-12 md:py-20  px-4">
      <div className="w-full sm:w-11/12 md:w-10/12 lg:w-8/12 bg-white shadow-2xl rounded-3xl flex flex-col md:flex-row overflow-hidden border border-gray-200">

        {/* Left Section */}
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-10">
          <div className="w-full sm:w-[80%]">
            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-800 mb-1 text-center md:text-left">
              Welcome To{" "}
